...
@section('title')
    <title>{{$column->name}} - Legal Indaba</title>
    <meta name="description" content="Legal Indaba, Zambian Legal Magazine. A look of all the articles in the '{{$column->name}}' column" />
@endsection
