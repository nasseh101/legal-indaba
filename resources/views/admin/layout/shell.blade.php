...
<head>
    ...
    <meta name="description" content="Ledal Indaba Admin Section">
    ...
    <aside class="left-side sidebar-offcanvas">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="/admin-section/issues/">
                        <i class="fa fa-columns"></i> <span>Manage Issues</span>
                    </a>
                </li>
